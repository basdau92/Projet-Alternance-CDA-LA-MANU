    ...
    public function run()
    {
        DB::table('property')->insert([
            ...
            [
                ...
                'id_heater' => 2,
                'id_energy_audit' => 1,
                'name' => 'Appartement résidence Hyrule',
                'price' => 203875,
                'address' => '22C résidence Hyrule',
                'addition_address' => 'Appartement 2',
                'zipcode' => 75020,
                'city' => 'Paris',
                'surface' => 90,
                'description' => 'Appartement neuf situé au 42e étage avec ascenceur.',
                'is_furnished' => false,
                'is_available' => true,
                'is_prospect' => true,
                'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
